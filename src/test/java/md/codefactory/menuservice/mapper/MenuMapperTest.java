...
public class MenuMapperTest {
    ...
    public void should_map_newMenuDto_to_food() {
        ...
        assertThat(menu.getFood()).isEqualTo(newMenuDto.getFood());
    }
    ...
    public void should_map_food_to_newMenuDto() {
        ...
        assertThat(newMenuDto.getFood()).isEqualTo(menu.getFood());
    }
    ...
    public void should_map_updateMenuDto_to_food() {
        ...
        assertThat(menu.getFood()).isEqualTo(updateMenuDto.getFood());
    }
    ...
    public void should_map_food_to_updateMenuDto() {
        ...
        assertThat(updateMenuDto.getFood()).isEqualTo(menu.getFood());
    }
    ...
    public void should_map_viewMenuDto_to_food() {
        ...
        assertThat(viewMenuDto.getFood()).isEqualTo(menu.getFood());
    }
}